    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 480, position: 'relative', zIndex: 1 }}>
        ...
        <div className="card" style={{ padding: 40 }}>
          <h1 style={{ fontSize: '1.625rem', fontWeight: 800, color: '#f1f5f9', marginBottom: 8 }}>Create your account</h1>
          <p style={{ color: '#64748b', marginBottom: 32, fontSize: '0.9375rem' }}>Start your 14-day free trial today</p>
